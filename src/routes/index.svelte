<script lang="ts">
    ...
    let tune = new HandpanTune([
        ...
        new HandpanNote(Note.A, NoteAlteration.none, 4, HandpanNoteType.topNote, 0),
        new HandpanNote(Note.B, NoteAlteration.none, 4, HandpanNoteType.topNote, 1),
